...
| hosts-3d | 740 | Hosts that connected within the last 3 days. |
| hosts-1w | 1615 | Hosts that connected within the last 7 days. |
| hosts-3w | 4531 | Hosts that connected within the last 21 days. |
| hosts-1m | 7895 | Hosts that connected within the last month. |
| hosts-3m | 19559 | Hosts that connected within the last 3 months. |
| users-1d | 594 | Usernames used to connect within the last 24 hours. |
| users-3d | 1147 | Usernames used to connect within the last 3 days. |
| users-1w | 2040 | Usernames used to connect within the last 7 days. |
| users-3w | 4369 | Usernames used to connect within the last 21 days. |
| users-1m | 5237 | Usernames used to connect within the last month. |
| users-3m | 10099 | Usernames used to connect within the last 3 months. |
| passwords-1d | 1149 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 3167 | Passwords used to connect within the last 3 days. |
| passwords-1w | 6473 | Passwords used to connect within the last 7 days. |
| passwords-3w | 25791 | Passwords used to connect within the last 21 days. |
| passwords-1m | 60705 | Passwords used to connect within the last month. |
| passwords-3m | 114651 | Passwords used to connect within the last 3 months. |
...
| destinations-3w | 36 | Destinations of proxy attempts within the last 21 days. |
| destinations-1m | 63 | Destinations of proxy attempts within the last month. |
| destinations-3m | 116 | Destinations of proxy attempts within the last 3 months. |
...
| payloads-3w | 74 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 168 | Payloads execution attempts within the last month. |
...
| new-passwords-1d | 114 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 453 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 1341 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 4217 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 8520 | New passwords used to connect within the last month. |
| new-passwords-3m | 45218 | New passwords used to connect within the last 3 months. |
