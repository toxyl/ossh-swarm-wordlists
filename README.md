...
| hosts-3d | 955 | Hosts that connected within the last 3 days. |
| hosts-1w | 2379 | Hosts that connected within the last 7 days. |
| hosts-3w | 6169 | Hosts that connected within the last 21 days. |
| hosts-1m | 8370 | Hosts that connected within the last month. |
| hosts-3m | 24803 | Hosts that connected within the last 3 months. |
| users-1d | 632 | Usernames used to connect within the last 24 hours. |
| users-3d | 935 | Usernames used to connect within the last 3 days. |
| users-1w | 1457 | Usernames used to connect within the last 7 days. |
| users-3w | 2572 | Usernames used to connect within the last 21 days. |
| users-1m | 5724 | Usernames used to connect within the last month. |
| users-3m | 15432 | Usernames used to connect within the last 3 months. |
| passwords-1d | 19530 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 30767 | Passwords used to connect within the last 3 days. |
| passwords-1w | 34931 | Passwords used to connect within the last 7 days. |
| passwords-3w | 61943 | Passwords used to connect within the last 21 days. |
| passwords-1m | 85364 | Passwords used to connect within the last month. |
| passwords-3m | 128130 | Passwords used to connect within the last 3 months. |
...
| payloads-3d | 72 | Payloads execution attempts within the last 3 days. |
...
| payloads-1m | 260 | Payloads execution attempts within the last month. |
...
| new-passwords-3d | 660 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 2626 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 9358 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 29497 | New passwords used to connect within the last month. |
| new-passwords-3m | 61282 | New passwords used to connect within the last 3 months. |
