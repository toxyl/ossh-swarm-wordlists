...
| --- | --- | --- |
| hosts-1d | 442 | Hosts that connected within the last 24 hours. |
| hosts-3d | 1111 | Hosts that connected within the last 3 days. |
| hosts-1w | 2406 | Hosts that connected within the last 7 days. |
| hosts-3w | 6009 | Hosts that connected within the last 21 days. |
| hosts-1m | 7838 | Hosts that connected within the last month. |
| hosts-3m | 24303 | Hosts that connected within the last 3 months. |
| users-1d | 574 | Usernames used to connect within the last 24 hours. |
| users-3d | 1178 | Usernames used to connect within the last 3 days. |
| users-1w | 1545 | Usernames used to connect within the last 7 days. |
| users-3w | 2647 | Usernames used to connect within the last 21 days. |
| users-1m | 3026 | Usernames used to connect within the last month. |
| users-3m | 13699 | Usernames used to connect within the last 3 months. |
| passwords-1d | 1754 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 8685 | Passwords used to connect within the last 3 days. |
| passwords-1w | 29867 | Passwords used to connect within the last 7 days. |
| passwords-3w | 48772 | Passwords used to connect within the last 21 days. |
| passwords-1m | 55390 | Passwords used to connect within the last month. |
| passwords-3m | 121900 | Passwords used to connect within the last 3 months. |
...
| destinations-3m | 161 | Destinations of proxy attempts within the last 3 months. |
...
| payloads-1m | 151 | Payloads execution attempts within the last month. |
| payloads-3m | 660 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 80 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 485 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 1457 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 8008 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 10948 | New passwords used to connect within the last month. |
| new-passwords-3m | 57981 | New passwords used to connect within the last 3 months. |
...
| new-payloads-1m | 6 | New payloads execution attempts within the last month. |
