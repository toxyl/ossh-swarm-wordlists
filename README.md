...
| --- | --- | --- |
| hosts-1d | 256 | Hosts that connected within the last 24 hours. |
| hosts-3d | 563 | Hosts that connected within the last 3 days. |
| hosts-1w | 1179 | Hosts that connected within the last 7 days. |
| hosts-3w | 3315 | Hosts that connected within the last 21 days. |
| hosts-1m | 4815 | Hosts that connected within the last month. |
| hosts-3m | 16508 | Hosts that connected within the last 3 months. |
| users-1d | 627 | Usernames used to connect within the last 24 hours. |
| users-3d | 1082 | Usernames used to connect within the last 3 days. |
| users-1w | 2314 | Usernames used to connect within the last 7 days. |
| users-3w | 4584 | Usernames used to connect within the last 21 days. |
| users-1m | 5528 | Usernames used to connect within the last month. |
| users-3m | 10439 | Usernames used to connect within the last 3 months. |
| passwords-1d | 1218 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 3871 | Passwords used to connect within the last 3 days. |
| passwords-1w | 7673 | Passwords used to connect within the last 7 days. |
| passwords-3w | 18552 | Passwords used to connect within the last 21 days. |
| passwords-1m | 27909 | Passwords used to connect within the last month. |
| passwords-3m | 80728 | Passwords used to connect within the last 3 months. |
...
| payloads-3w | 100 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 142 | Payloads execution attempts within the last month. |
| payloads-3m | 681 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 68 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 265 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 577 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 2559 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 4057 | New passwords used to connect within the last month. |
| new-passwords-3m | 19493 | New passwords used to connect within the last 3 months. |
