...
| --- | --- | --- |
| hosts-1d | 397 | Hosts that connected within the last 24 hours. |
| hosts-3d | 776 | Hosts that connected within the last 3 days. |
| hosts-1w | 1560 | Hosts that connected within the last 7 days. |
| hosts-3w | 3913 | Hosts that connected within the last 21 days. |
| hosts-1m | 5175 | Hosts that connected within the last month. |
| hosts-3m | 17335 | Hosts that connected within the last 3 months. |
| users-1d | 1260 | Usernames used to connect within the last 24 hours. |
| users-3d | 2139 | Usernames used to connect within the last 3 days. |
| users-1w | 3137 | Usernames used to connect within the last 7 days. |
| users-3w | 4816 | Usernames used to connect within the last 21 days. |
| users-1m | 5960 | Usernames used to connect within the last month. |
| users-3m | 10254 | Usernames used to connect within the last 3 months. |
| passwords-1d | 2205 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 3562 | Passwords used to connect within the last 3 days. |
| passwords-1w | 7771 | Passwords used to connect within the last 7 days. |
| passwords-3w | 22458 | Passwords used to connect within the last 21 days. |
| passwords-1m | 30052 | Passwords used to connect within the last month. |
| passwords-3m | 83567 | Passwords used to connect within the last 3 months. |
...
| payloads-3d | 14 | Payloads execution attempts within the last 3 days. |
| payloads-1w | 84 | Payloads execution attempts within the last 7 days. |
| payloads-3w | 134 | Payloads execution attempts within the last 21 days. |
...
| new-passwords-1d | 324 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 551 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 1217 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 3132 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 5376 | New passwords used to connect within the last month. |
| new-passwords-3m | 21061 | New passwords used to connect within the last 3 months. |
