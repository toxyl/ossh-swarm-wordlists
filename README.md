...
| hosts-1w | 1887 | Hosts that connected within the last 7 days. |
| hosts-3w | 3998 | Hosts that connected within the last 21 days. |
| hosts-1m | 5333 | Hosts that connected within the last month. |
| hosts-3m | 15796 | Hosts that connected within the last 3 months. |
| users-1d | 782 | Usernames used to connect within the last 24 hours. |
| users-3d | 1286 | Usernames used to connect within the last 3 days. |
| users-1w | 1960 | Usernames used to connect within the last 7 days. |
| users-3w | 3923 | Usernames used to connect within the last 21 days. |
| users-1m | 5532 | Usernames used to connect within the last month. |
| users-3m | 10173 | Usernames used to connect within the last 3 months. |
| passwords-1d | 7207 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 10333 | Passwords used to connect within the last 3 days. |
| passwords-1w | 15268 | Passwords used to connect within the last 7 days. |
| passwords-3w | 24618 | Passwords used to connect within the last 21 days. |
| passwords-1m | 29834 | Passwords used to connect within the last month. |
| passwords-3m | 82385 | Passwords used to connect within the last 3 months. |
...
| payloads-3w | 46 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 67 | Payloads execution attempts within the last month. |
| payloads-3m | 382 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 3935 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 4792 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 5490 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 7126 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 8810 | New passwords used to connect within the last month. |
| new-passwords-3m | 23093 | New passwords used to connect within the last 3 months. |
