...
| --- | --- | --- |
| hosts-1d | 0 | Hosts that connected within the last 24 hours. |
| hosts-3d | 0 | Hosts that connected within the last 3 days. |
| hosts-1w | 0 | Hosts that connected within the last 7 days. |
| hosts-3w | 0 | Hosts that connected within the last 21 days. |
| hosts-1m | 0 | Hosts that connected within the last month. |
| hosts-3m | 0 | Hosts that connected within the last 3 months. |
| users-1d | 0 | Usernames used to connect within the last 24 hours. |
| users-3d | 0 | Usernames used to connect within the last 3 days. |
| users-1w | 0 | Usernames used to connect within the last 7 days. |
| users-3w | 0 | Usernames used to connect within the last 21 days. |
| users-1m | 0 | Usernames used to connect within the last month. |
| users-3m | 0 | Usernames used to connect within the last 3 months. |
| passwords-1d | 0 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 0 | Passwords used to connect within the last 3 days. |
| passwords-1w | 0 | Passwords used to connect within the last 7 days. |
| passwords-3w | 0 | Passwords used to connect within the last 21 days. |
| passwords-1m | 0 | Passwords used to connect within the last month. |
| passwords-3m | 0 | Passwords used to connect within the last 3 months. |
...
| new-passwords-1w | 997 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 4030 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 5677 | New passwords used to connect within the last month. |
| new-passwords-3m | 23871 | New passwords used to connect within the last 3 months. |
