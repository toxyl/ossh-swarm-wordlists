...
| --- | --- | --- |
| hosts-1d | 279 | Hosts that connected within the last 24 hours. |
| hosts-3d | 769 | Hosts that connected within the last 3 days. |
| hosts-1w | 1648 | Hosts that connected within the last 7 days. |
| hosts-3w | 4879 | Hosts that connected within the last 21 days. |
| hosts-1m | 8006 | Hosts that connected within the last month. |
| hosts-3m | 19573 | Hosts that connected within the last 3 months. |
| users-1d | 654 | Usernames used to connect within the last 24 hours. |
| users-3d | 1231 | Usernames used to connect within the last 3 days. |
| users-1w | 2093 | Usernames used to connect within the last 7 days. |
| users-3w | 4534 | Usernames used to connect within the last 21 days. |
| users-1m | 5324 | Usernames used to connect within the last month. |
| users-3m | 10121 | Usernames used to connect within the last 3 months. |
| passwords-1d | 1298 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 3444 | Passwords used to connect within the last 3 days. |
| passwords-1w | 6610 | Passwords used to connect within the last 7 days. |
| passwords-3w | 28154 | Passwords used to connect within the last 21 days. |
| passwords-1m | 60659 | Passwords used to connect within the last month. |
| passwords-3m | 114634 | Passwords used to connect within the last 3 months. |
...
| payloads-3w | 94 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 171 | Payloads execution attempts within the last month. |
| payloads-3m | 717 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 115 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 498 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 1379 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 5008 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 8454 | New passwords used to connect within the last month. |
| new-passwords-3m | 45191 | New passwords used to connect within the last 3 months. |
