...
| hosts-3d | 1916 | Hosts that connected within the last 3 days. |
| hosts-1w | 3909 | Hosts that connected within the last 7 days. |
| hosts-3w | 10977 | Hosts that connected within the last 21 days. |
| hosts-1m | 13344 | Hosts that connected within the last month. |
| hosts-3m | 20889 | Hosts that connected within the last 3 months. |
| users-1d | 902 | Usernames used to connect within the last 24 hours. |
| users-3d | 1365 | Usernames used to connect within the last 3 days. |
| users-1w | 2740 | Usernames used to connect within the last 7 days. |
| users-3w | 18831 | Usernames used to connect within the last 21 days. |
| users-1m | 19405 | Usernames used to connect within the last month. |
| users-3m | 23145 | Usernames used to connect within the last 3 months. |
| passwords-1d | 6718 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 41672 | Passwords used to connect within the last 3 days. |
| passwords-1w | 48373 | Passwords used to connect within the last 7 days. |
| passwords-3w | 101507 | Passwords used to connect within the last 21 days. |
| passwords-1m | 108867 | Passwords used to connect within the last month. |
| passwords-3m | 140674 | Passwords used to connect within the last 3 months. |
...
| payloads-1w | 74 | Payloads execution attempts within the last 7 days. |
...
| new-passwords-3d | 779 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 1536 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 38629 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 45460 | New passwords used to connect within the last month. |
| new-passwords-3m | 74185 | New passwords used to connect within the last 3 months. |
