...
| --- | --- | --- |
| hosts-1d | 226 | Hosts that connected within the last 24 hours. |
| hosts-3d | 609 | Hosts that connected within the last 3 days. |
| hosts-1w | 1139 | Hosts that connected within the last 7 days. |
| hosts-3w | 3313 | Hosts that connected within the last 21 days. |
| hosts-1m | 4729 | Hosts that connected within the last month. |
| hosts-3m | 16442 | Hosts that connected within the last 3 months. |
| users-1d | 573 | Usernames used to connect within the last 24 hours. |
| users-3d | 1482 | Usernames used to connect within the last 3 days. |
| users-1w | 2365 | Usernames used to connect within the last 7 days. |
| users-3w | 4598 | Usernames used to connect within the last 21 days. |
| users-1m | 5488 | Usernames used to connect within the last month. |
| users-3m | 10424 | Usernames used to connect within the last 3 months. |
| passwords-1d | 2894 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 4230 | Passwords used to connect within the last 3 days. |
| passwords-1w | 7636 | Passwords used to connect within the last 7 days. |
| passwords-3w | 18619 | Passwords used to connect within the last 21 days. |
| passwords-1m | 27737 | Passwords used to connect within the last month. |
| passwords-3m | 80633 | Passwords used to connect within the last 3 months. |
...
| payloads-1w | 33 | Payloads execution attempts within the last 7 days. |
| payloads-3w | 100 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 141 | Payloads execution attempts within the last month. |
| payloads-3m | 680 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-3d | 287 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 568 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 2557 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 3989 | New passwords used to connect within the last month. |
| new-passwords-3m | 19425 | New passwords used to connect within the last 3 months. |
