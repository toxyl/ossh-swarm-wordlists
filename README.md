...
| --- | --- | --- |
| hosts-1d | 535 | Hosts that connected within the last 24 hours. |
| hosts-3d | 1716 | Hosts that connected within the last 3 days. |
| hosts-1w | 2898 | Hosts that connected within the last 7 days. |
| hosts-3w | 5688 | Hosts that connected within the last 21 days. |
| hosts-1m | 7146 | Hosts that connected within the last month. |
| hosts-3m | 15186 | Hosts that connected within the last 3 months. |
| users-1d | 466 | Usernames used to connect within the last 24 hours. |
| users-3d | 1147 | Usernames used to connect within the last 3 days. |
| users-1w | 1677 | Usernames used to connect within the last 7 days. |
| users-3w | 3295 | Usernames used to connect within the last 21 days. |
| users-1m | 4198 | Usernames used to connect within the last month. |
| users-3m | 10089 | Usernames used to connect within the last 3 months. |
| passwords-1d | 4945 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 8634 | Passwords used to connect within the last 3 days. |
| passwords-1w | 13838 | Passwords used to connect within the last 7 days. |
| passwords-3w | 46451 | Passwords used to connect within the last 21 days. |
| passwords-1m | 51721 | Passwords used to connect within the last month. |
| passwords-3m | 93051 | Passwords used to connect within the last 3 months. |
...
| destinations-3m | 69 | Destinations of proxy attempts within the last 3 months. |
...
| payloads-3m | 338 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 1170 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 2240 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 3790 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 25252 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 26545 | New passwords used to connect within the last month. |
| new-passwords-3m | 39718 | New passwords used to connect within the last 3 months. |
