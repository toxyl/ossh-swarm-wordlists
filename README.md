...
| --- | --- | --- |
| hosts-1d | 417 | Hosts that connected within the last 24 hours. |
| hosts-3d | 1058 | Hosts that connected within the last 3 days. |
| hosts-1w | 2900 | Hosts that connected within the last 7 days. |
| hosts-3w | 6724 | Hosts that connected within the last 21 days. |
| hosts-1m | 10446 | Hosts that connected within the last month. |
| hosts-3m | 26128 | Hosts that connected within the last 3 months. |
| users-1d | 615 | Usernames used to connect within the last 24 hours. |
| users-3d | 1106 | Usernames used to connect within the last 3 days. |
| users-1w | 1601 | Usernames used to connect within the last 7 days. |
| users-3w | 5447 | Usernames used to connect within the last 21 days. |
| users-1m | 7473 | Usernames used to connect within the last month. |
| users-3m | 16325 | Usernames used to connect within the last 3 months. |
| passwords-1d | 3804 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 10895 | Passwords used to connect within the last 3 days. |
| passwords-1w | 30537 | Passwords used to connect within the last 7 days. |
| passwords-3w | 78416 | Passwords used to connect within the last 21 days. |
| passwords-1m | 86119 | Passwords used to connect within the last month. |
| passwords-3m | 128183 | Passwords used to connect within the last 3 months. |
...
| destinations-1m | 93 | Destinations of proxy attempts within the last month. |
...
| new-passwords-1d | 450 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 1314 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 3553 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 26488 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 32158 | New passwords used to connect within the last month. |
| new-passwords-3m | 62848 | New passwords used to connect within the last 3 months. |
