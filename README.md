...
| --- | --- | --- |
| hosts-1d | 340 | Hosts that connected within the last 24 hours. |
| hosts-3d | 774 | Hosts that connected within the last 3 days. |
| hosts-1w | 1465 | Hosts that connected within the last 7 days. |
| hosts-3w | 4043 | Hosts that connected within the last 21 days. |
| hosts-1m | 5137 | Hosts that connected within the last month. |
| hosts-3m | 17486 | Hosts that connected within the last 3 months. |
| users-1d | 1045 | Usernames used to connect within the last 24 hours. |
| users-3d | 2103 | Usernames used to connect within the last 3 days. |
| users-1w | 2894 | Usernames used to connect within the last 7 days. |
| users-3w | 4901 | Usernames used to connect within the last 21 days. |
| users-1m | 5948 | Usernames used to connect within the last month. |
| users-3m | 10063 | Usernames used to connect within the last 3 months. |
| passwords-1d | 1438 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 4598 | Passwords used to connect within the last 3 days. |
| passwords-1w | 8880 | Passwords used to connect within the last 7 days. |
| passwords-3w | 22856 | Passwords used to connect within the last 21 days. |
| passwords-1m | 29658 | Passwords used to connect within the last month. |
| passwords-3m | 83650 | Passwords used to connect within the last 3 months. |
...
| payloads-3w | 139 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 225 | Payloads execution attempts within the last month. |
...
| new-passwords-1d | 182 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 343 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 632 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 3346 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 5186 | New passwords used to connect within the last month. |
| new-passwords-3m | 21110 | New passwords used to connect within the last 3 months. |
