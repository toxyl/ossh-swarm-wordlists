...
| --- | --- | --- |
| hosts-1d | 421 | Hosts that connected within the last 24 hours. |
| hosts-3d | 1201 | Hosts that connected within the last 3 days. |
| hosts-1w | 3358 | Hosts that connected within the last 7 days. |
| hosts-3w | 7961 | Hosts that connected within the last 21 days. |
| hosts-1m | 9483 | Hosts that connected within the last month. |
| hosts-3m | 22598 | Hosts that connected within the last 3 months. |
| users-1d | 604 | Usernames used to connect within the last 24 hours. |
| users-3d | 1040 | Usernames used to connect within the last 3 days. |
| users-1w | 2067 | Usernames used to connect within the last 7 days. |
| users-3w | 3698 | Usernames used to connect within the last 21 days. |
| users-1m | 4227 | Usernames used to connect within the last month. |
| users-3m | 10063 | Usernames used to connect within the last 3 months. |
| passwords-1d | 34473 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 38886 | Passwords used to connect within the last 3 days. |
| passwords-1w | 43770 | Passwords used to connect within the last 7 days. |
| passwords-3w | 58119 | Passwords used to connect within the last 21 days. |
| passwords-1m | 61110 | Passwords used to connect within the last month. |
| passwords-3m | 116497 | Passwords used to connect within the last 3 months. |
...
| new-passwords-1d | 40 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 252 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 1243 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 4521 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 5877 | New passwords used to connect within the last month. |
| new-passwords-3m | 47134 | New passwords used to connect within the last 3 months. |
