...
| --- | --- | --- |
| hosts-1d | 261 | Hosts that connected within the last 24 hours. |
| hosts-3d | 506 | Hosts that connected within the last 3 days. |
| hosts-1w | 1444 | Hosts that connected within the last 7 days. |
| hosts-3w | 3661 | Hosts that connected within the last 21 days. |
| hosts-1m | 5083 | Hosts that connected within the last month. |
| hosts-3m | 16825 | Hosts that connected within the last 3 months. |
| users-1d | 1014 | Usernames used to connect within the last 24 hours. |
| users-3d | 1505 | Usernames used to connect within the last 3 days. |
| users-1w | 3090 | Usernames used to connect within the last 7 days. |
| users-3w | 4761 | Usernames used to connect within the last 21 days. |
| users-1m | 5976 | Usernames used to connect within the last month. |
| users-3m | 10453 | Usernames used to connect within the last 3 months. |
| passwords-1d | 2051 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 2725 | Passwords used to connect within the last 3 days. |
| passwords-1w | 7850 | Passwords used to connect within the last 7 days. |
| passwords-3w | 23329 | Passwords used to connect within the last 21 days. |
| passwords-1m | 27961 | Passwords used to connect within the last month. |
| passwords-3m | 81496 | Passwords used to connect within the last 3 months. |
...
| payloads-1d | 7 | Payloads execution attempts within the last 24 hours. |
...
| new-passwords-1d | 86 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 166 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 1085 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 2971 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 4848 | New passwords used to connect within the last month. |
| new-passwords-3m | 19812 | New passwords used to connect within the last 3 months. |
