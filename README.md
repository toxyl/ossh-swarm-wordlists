...
| hosts-3d | 931 | Hosts that connected within the last 3 days. |
| hosts-1w | 1550 | Hosts that connected within the last 7 days. |
| hosts-3w | 3433 | Hosts that connected within the last 21 days. |
| hosts-1m | 4742 | Hosts that connected within the last month. |
| hosts-3m | 16311 | Hosts that connected within the last 3 months. |
| users-1d | 723 | Usernames used to connect within the last 24 hours. |
| users-3d | 1267 | Usernames used to connect within the last 3 days. |
| users-1w | 1907 | Usernames used to connect within the last 7 days. |
| users-3w | 4663 | Usernames used to connect within the last 21 days. |
| users-1m | 5447 | Usernames used to connect within the last month. |
| users-3m | 10345 | Usernames used to connect within the last 3 months. |
| passwords-1d | 1950 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 7209 | Passwords used to connect within the last 3 days. |
| passwords-1w | 11167 | Passwords used to connect within the last 7 days. |
| passwords-3w | 19727 | Passwords used to connect within the last 21 days. |
| passwords-1m | 29885 | Passwords used to connect within the last month. |
| passwords-3m | 80412 | Passwords used to connect within the last 3 months. |
...
| payloads-1m | 112 | Payloads execution attempts within the last month. |
...
| new-passwords-3d | 627 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 873 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 2798 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 3817 | New passwords used to connect within the last month. |
| new-passwords-3m | 19592 | New passwords used to connect within the last 3 months. |
