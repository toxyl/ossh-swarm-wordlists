...
| --- | --- | --- |
| hosts-1d | 460 | Hosts that connected within the last 24 hours. |
| hosts-3d | 1121 | Hosts that connected within the last 3 days. |
| hosts-1w | 2041 | Hosts that connected within the last 7 days. |
| hosts-3w | 5896 | Hosts that connected within the last 21 days. |
| hosts-1m | 8428 | Hosts that connected within the last month. |
| hosts-3m | 24792 | Hosts that connected within the last 3 months. |
| users-1d | 594 | Usernames used to connect within the last 24 hours. |
| users-3d | 927 | Usernames used to connect within the last 3 days. |
| users-1w | 1406 | Usernames used to connect within the last 7 days. |
| users-3w | 2417 | Usernames used to connect within the last 21 days. |
| users-1m | 5658 | Usernames used to connect within the last month. |
| users-3m | 15277 | Usernames used to connect within the last 3 months. |
| passwords-1d | 3197 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 28692 | Passwords used to connect within the last 3 days. |
| passwords-1w | 34489 | Passwords used to connect within the last 7 days. |
| passwords-3w | 49668 | Passwords used to connect within the last 21 days. |
| passwords-1m | 85429 | Passwords used to connect within the last month. |
| passwords-3m | 124756 | Passwords used to connect within the last 3 months. |
...
| payloads-1m | 234 | Payloads execution attempts within the last month. |
...
| new-passwords-1d | 542 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 1029 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 1962 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 8803 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 29961 | New passwords used to connect within the last month. |
| new-passwords-3m | 60969 | New passwords used to connect within the last 3 months. |
