...
| hosts-3d | 1898 | Hosts that connected within the last 3 days. |
| hosts-1w | 3722 | Hosts that connected within the last 7 days. |
| hosts-3w | 9216 | Hosts that connected within the last 21 days. |
| hosts-1m | 11270 | Hosts that connected within the last month. |
| hosts-3m | 23812 | Hosts that connected within the last 3 months. |
| users-1d | 1246 | Usernames used to connect within the last 24 hours. |
| users-3d | 2012 | Usernames used to connect within the last 3 days. |
| users-1w | 2536 | Usernames used to connect within the last 7 days. |
| users-3w | 4929 | Usernames used to connect within the last 21 days. |
| users-1m | 5560 | Usernames used to connect within the last month. |
| users-3m | 14285 | Usernames used to connect within the last 3 months. |
| passwords-1d | 6402 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 23955 | Passwords used to connect within the last 3 days. |
| passwords-1w | 29183 | Passwords used to connect within the last 7 days. |
| passwords-3w | 42820 | Passwords used to connect within the last 21 days. |
| passwords-1m | 48680 | Passwords used to connect within the last month. |
| passwords-3m | 124331 | Passwords used to connect within the last 3 months. |
...
| destinations-1w | 47 | Destinations of proxy attempts within the last 7 days. |
...
| payloads-1m | 243 | Payloads execution attempts within the last month. |
| payloads-3m | 783 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 470 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 2045 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 3885 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 8398 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 11934 | New passwords used to connect within the last month. |
| new-passwords-3m | 63492 | New passwords used to connect within the last 3 months. |
