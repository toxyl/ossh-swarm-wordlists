...
| --- | --- | --- |
| hosts-1d | 419 | Hosts that connected within the last 24 hours. |
| hosts-3d | 1249 | Hosts that connected within the last 3 days. |
| hosts-1w | 2041 | Hosts that connected within the last 7 days. |
| hosts-3w | 4169 | Hosts that connected within the last 21 days. |
| hosts-1m | 5468 | Hosts that connected within the last month. |
| hosts-3m | 18498 | Hosts that connected within the last 3 months. |
| users-1d | 594 | Usernames used to connect within the last 24 hours. |
| users-3d | 1263 | Usernames used to connect within the last 3 days. |
| users-1w | 2153 | Usernames used to connect within the last 7 days. |
| users-3w | 4277 | Usernames used to connect within the last 21 days. |
| users-1m | 5194 | Usernames used to connect within the last month. |
| users-3m | 8849 | Usernames used to connect within the last 3 months. |
| passwords-1d | 1452 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 3675 | Passwords used to connect within the last 3 days. |
| passwords-1w | 10856 | Passwords used to connect within the last 7 days. |
| passwords-3w | 19165 | Passwords used to connect within the last 21 days. |
| passwords-1m | 32690 | Passwords used to connect within the last month. |
| passwords-3m | 89368 | Passwords used to connect within the last 3 months. |
...
| payloads-3w | 185 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 187 | Payloads execution attempts within the last month. |
...
| new-hosts-3m | 22 | New hosts that connected within the last 3 months. |
...
| new-users-3m | 22 | New usernames used to connect within the last 3 months. |
| new-passwords-1d | 223 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 932 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 1718 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 4440 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 5860 | New passwords used to connect within the last month. |
| new-passwords-3m | 26078 | New passwords used to connect within the last 3 months. |
...
| new-payloads-3m | 20 | New payloads execution attempts within the last 3 months. |
