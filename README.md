...
| --- | --- | --- |
| hosts-1d | 265 | Hosts that connected within the last 24 hours. |
| hosts-3d | 701 | Hosts that connected within the last 3 days. |
| hosts-1w | 1646 | Hosts that connected within the last 7 days. |
| hosts-3w | 4339 | Hosts that connected within the last 21 days. |
| hosts-1m | 5348 | Hosts that connected within the last month. |
| hosts-3m | 14837 | Hosts that connected within the last 3 months. |
| users-1d | 369 | Usernames used to connect within the last 24 hours. |
| users-3d | 646 | Usernames used to connect within the last 3 days. |
| users-1w | 1454 | Usernames used to connect within the last 7 days. |
| users-3w | 3409 | Usernames used to connect within the last 21 days. |
| users-1m | 4868 | Usernames used to connect within the last month. |
| users-3m | 9977 | Usernames used to connect within the last 3 months. |
| passwords-1d | 3854 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 15215 | Passwords used to connect within the last 3 days. |
| passwords-1w | 33120 | Passwords used to connect within the last 7 days. |
| passwords-3w | 44101 | Passwords used to connect within the last 21 days. |
| passwords-1m | 46937 | Passwords used to connect within the last month. |
| passwords-3m | 98240 | Passwords used to connect within the last 3 months. |
...
| payloads-3w | 53 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 60 | Payloads execution attempts within the last month. |
| payloads-3m | 371 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 630 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 5653 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 19642 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 22342 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 23221 | New passwords used to connect within the last month. |
| new-passwords-3m | 37243 | New passwords used to connect within the last 3 months. |
