...
| --- | --- | --- |
| hosts-1d | 270 | Hosts that connected within the last 24 hours. |
| hosts-3d | 888 | Hosts that connected within the last 3 days. |
| hosts-1w | 1761 | Hosts that connected within the last 7 days. |
| hosts-3w | 4136 | Hosts that connected within the last 21 days. |
| hosts-1m | 5343 | Hosts that connected within the last month. |
| hosts-3m | 15469 | Hosts that connected within the last 3 months. |
| users-1d | 385 | Usernames used to connect within the last 24 hours. |
| users-3d | 1204 | Usernames used to connect within the last 3 days. |
| users-1w | 1994 | Usernames used to connect within the last 7 days. |
| users-3w | 3982 | Usernames used to connect within the last 21 days. |
| users-1m | 5580 | Usernames used to connect within the last month. |
| users-3m | 10252 | Usernames used to connect within the last 3 months. |
| passwords-1d | 1283 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 21162 | Passwords used to connect within the last 3 days. |
| passwords-1w | 26013 | Passwords used to connect within the last 7 days. |
| passwords-3w | 36596 | Passwords used to connect within the last 21 days. |
| passwords-1m | 41693 | Passwords used to connect within the last month. |
| passwords-3m | 93176 | Passwords used to connect within the last 3 months. |
...
| payloads-3w | 44 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 63 | Payloads execution attempts within the last month. |
| payloads-3m | 380 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-3d | 13918 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 15127 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 16973 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 18288 | New passwords used to connect within the last month. |
| new-passwords-3m | 32510 | New passwords used to connect within the last 3 months. |
