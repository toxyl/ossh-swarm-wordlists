...
| hosts-1w | 1680 | Hosts that connected within the last 7 days. |
| hosts-3w | 4155 | Hosts that connected within the last 21 days. |
| hosts-1m | 5397 | Hosts that connected within the last month. |
| hosts-3m | 15212 | Hosts that connected within the last 3 months. |
| users-1d | 453 | Usernames used to connect within the last 24 hours. |
| users-3d | 1026 | Usernames used to connect within the last 3 days. |
| users-1w | 1845 | Usernames used to connect within the last 7 days. |
| users-3w | 3674 | Usernames used to connect within the last 21 days. |
| users-1m | 5510 | Usernames used to connect within the last month. |
| users-3m | 10205 | Usernames used to connect within the last 3 months. |
| passwords-1d | 2081 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 16892 | Passwords used to connect within the last 3 days. |
| passwords-1w | 25906 | Passwords used to connect within the last 7 days. |
| passwords-3w | 36728 | Passwords used to connect within the last 21 days. |
| passwords-1m | 41916 | Passwords used to connect within the last month. |
| passwords-3m | 92638 | Passwords used to connect within the last 3 months. |
...
| payloads-3m | 378 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 71 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 10054 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 14969 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 16954 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 18265 | New passwords used to connect within the last month. |
| new-passwords-3m | 32182 | New passwords used to connect within the last 3 months. |
