...
| --- | --- | --- |
| hosts-1d | 390 | Hosts that connected within the last 24 hours. |
| hosts-3d | 795 | Hosts that connected within the last 3 days. |
| hosts-1w | 1634 | Hosts that connected within the last 7 days. |
| hosts-3w | 4090 | Hosts that connected within the last 21 days. |
| hosts-1m | 7791 | Hosts that connected within the last month. |
| hosts-3m | 19470 | Hosts that connected within the last 3 months. |
| users-1d | 643 | Usernames used to connect within the last 24 hours. |
| users-3d | 1084 | Usernames used to connect within the last 3 days. |
| users-1w | 2071 | Usernames used to connect within the last 7 days. |
| users-3w | 3894 | Usernames used to connect within the last 21 days. |
| users-1m | 5323 | Usernames used to connect within the last month. |
| users-3m | 10108 | Usernames used to connect within the last 3 months. |
| passwords-1d | 2710 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 3785 | Passwords used to connect within the last 3 days. |
| passwords-1w | 6865 | Passwords used to connect within the last 7 days. |
| passwords-3w | 24827 | Passwords used to connect within the last 21 days. |
| passwords-1m | 61276 | Passwords used to connect within the last month. |
| passwords-3m | 114511 | Passwords used to connect within the last 3 months. |
...
| destinations-3m | 107 | Destinations of proxy attempts within the last 3 months. |
...
| payloads-1w | 146 | Payloads execution attempts within the last 7 days. |
| payloads-3w | 169 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 281 | Payloads execution attempts within the last month. |
| payloads-3m | 748 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 390 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 619 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 1457 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 3703 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 8874 | New passwords used to connect within the last month. |
| new-passwords-3m | 45069 | New passwords used to connect within the last 3 months. |
