...
| --- | --- | --- |
| hosts-1d | 494 | Hosts that connected within the last 24 hours. |
| hosts-3d | 1135 | Hosts that connected within the last 3 days. |
| hosts-1w | 2835 | Hosts that connected within the last 7 days. |
| hosts-3w | 6584 | Hosts that connected within the last 21 days. |
| hosts-1m | 10477 | Hosts that connected within the last month. |
| hosts-3m | 26264 | Hosts that connected within the last 3 months. |
| users-1d | 726 | Usernames used to connect within the last 24 hours. |
| users-3d | 1165 | Usernames used to connect within the last 3 days. |
| users-1w | 1417 | Usernames used to connect within the last 7 days. |
| users-3w | 5441 | Usernames used to connect within the last 21 days. |
| users-1m | 7498 | Usernames used to connect within the last month. |
| users-3m | 16340 | Usernames used to connect within the last 3 months. |
| passwords-1d | 6759 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 11188 | Passwords used to connect within the last 3 days. |
| passwords-1w | 25368 | Passwords used to connect within the last 7 days. |
| passwords-3w | 77888 | Passwords used to connect within the last 21 days. |
| passwords-1m | 86337 | Passwords used to connect within the last month. |
| passwords-3m | 128498 | Passwords used to connect within the last 3 months. |
...
| payloads-1w | 40 | Payloads execution attempts within the last 7 days. |
| payloads-3w | 280 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 392 | Payloads execution attempts within the last month. |
| payloads-3m | 893 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 305 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 1454 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 3328 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 25912 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 32206 | New passwords used to connect within the last month. |
| new-passwords-3m | 63101 | New passwords used to connect within the last 3 months. |
