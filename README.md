...
| --- | --- | --- |
| hosts-1d | 680 | Hosts that connected within the last 24 hours. |
| hosts-3d | 1574 | Hosts that connected within the last 3 days. |
| hosts-1w | 2960 | Hosts that connected within the last 7 days. |
| hosts-3w | 6300 | Hosts that connected within the last 21 days. |
| hosts-1m | 8152 | Hosts that connected within the last month. |
| hosts-3m | 22731 | Hosts that connected within the last 3 months. |
| users-1d | 701 | Usernames used to connect within the last 24 hours. |
| users-3d | 1536 | Usernames used to connect within the last 3 days. |
| users-1w | 1919 | Usernames used to connect within the last 7 days. |
| users-3w | 3090 | Usernames used to connect within the last 21 days. |
| users-1m | 3610 | Usernames used to connect within the last month. |
| users-3m | 10459 | Usernames used to connect within the last 3 months. |
| passwords-1d | 2410 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 4433 | Passwords used to connect within the last 3 days. |
| passwords-1w | 14412 | Passwords used to connect within the last 7 days. |
| passwords-3w | 44582 | Passwords used to connect within the last 21 days. |
| passwords-1m | 52093 | Passwords used to connect within the last month. |
| passwords-3m | 115116 | Passwords used to connect within the last 3 months. |
...
| payloads-3d | 53 | Payloads execution attempts within the last 3 days. |
| payloads-1w | 103 | Payloads execution attempts within the last 7 days. |
| payloads-3w | 158 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 192 | Payloads execution attempts within the last month. |
| payloads-3m | 641 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 45 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 257 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 707 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 4137 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 8971 | New passwords used to connect within the last month. |
| new-passwords-3m | 50474 | New passwords used to connect within the last 3 months. |
