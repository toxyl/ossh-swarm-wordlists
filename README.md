...
| --- | --- | --- |
| hosts-1d | 350 | Hosts that connected within the last 24 hours. |
| hosts-3d | 794 | Hosts that connected within the last 3 days. |
| hosts-1w | 1541 | Hosts that connected within the last 7 days. |
| hosts-3w | 3948 | Hosts that connected within the last 21 days. |
| hosts-1m | 7073 | Hosts that connected within the last month. |
| hosts-3m | 19080 | Hosts that connected within the last 3 months. |
| users-1d | 579 | Usernames used to connect within the last 24 hours. |
| users-3d | 1081 | Usernames used to connect within the last 3 days. |
| users-1w | 1768 | Usernames used to connect within the last 7 days. |
| users-3w | 3801 | Usernames used to connect within the last 21 days. |
| users-1m | 5447 | Usernames used to connect within the last month. |
| users-3m | 8374 | Usernames used to connect within the last 3 months. |
| passwords-1d | 1166 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 6571 | Passwords used to connect within the last 3 days. |
| passwords-1w | 9709 | Passwords used to connect within the last 7 days. |
| passwords-3w | 20272 | Passwords used to connect within the last 21 days. |
| passwords-1m | 45930 | Passwords used to connect within the last month. |
| passwords-3m | 102235 | Passwords used to connect within the last 3 months. |
...
| destinations-1w | 1 | Destinations of proxy attempts within the last 7 days. |
...
| payloads-3d | 20 | Payloads execution attempts within the last 3 days. |
| payloads-1w | 141 | Payloads execution attempts within the last 7 days. |
| payloads-3w | 168 | Payloads execution attempts within the last 21 days. |
...
| new-hosts-3m | 35 | New hosts that connected within the last 3 months. |
...
| new-users-3m | 35 | New usernames used to connect within the last 3 months. |
...
| new-passwords-1w | 1359 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 3907 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 9144 | New passwords used to connect within the last month. |
| new-passwords-3m | 35089 | New passwords used to connect within the last 3 months. |
