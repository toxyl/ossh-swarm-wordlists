...
| --- | --- | --- |
| hosts-1d | 327 | Hosts that connected within the last 24 hours. |
| hosts-3d | 728 | Hosts that connected within the last 3 days. |
| hosts-1w | 1457 | Hosts that connected within the last 7 days. |
| hosts-3w | 3997 | Hosts that connected within the last 21 days. |
| hosts-1m | 5116 | Hosts that connected within the last month. |
| hosts-3m | 17365 | Hosts that connected within the last 3 months. |
| users-1d | 1167 | Usernames used to connect within the last 24 hours. |
| users-3d | 1875 | Usernames used to connect within the last 3 days. |
| users-1w | 3000 | Usernames used to connect within the last 7 days. |
| users-3w | 4899 | Usernames used to connect within the last 21 days. |
| users-1m | 5908 | Usernames used to connect within the last month. |
| users-3m | 10196 | Usernames used to connect within the last 3 months. |
| passwords-1d | 1633 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 3154 | Passwords used to connect within the last 3 days. |
| passwords-1w | 7345 | Passwords used to connect within the last 7 days. |
| passwords-3w | 22523 | Passwords used to connect within the last 21 days. |
| passwords-1m | 29560 | Passwords used to connect within the last month. |
| passwords-3m | 83520 | Passwords used to connect within the last 3 months. |
...
| new-passwords-1d | 133 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 550 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 911 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 3323 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 5167 | New passwords used to connect within the last month. |
| new-passwords-3m | 21000 | New passwords used to connect within the last 3 months. |
