...
| --- | --- | --- |
| hosts-1d | 301 | Hosts that connected within the last 24 hours. |
| hosts-3d | 665 | Hosts that connected within the last 3 days. |
| hosts-1w | 2515 | Hosts that connected within the last 7 days. |
| hosts-3w | 7669 | Hosts that connected within the last 21 days. |
| hosts-1m | 10434 | Hosts that connected within the last month. |
| hosts-3m | 22401 | Hosts that connected within the last 3 months. |
| users-1d | 546 | Usernames used to connect within the last 24 hours. |
| users-3d | 910 | Usernames used to connect within the last 3 days. |
| users-1w | 2849 | Usernames used to connect within the last 7 days. |
| users-3w | 4505 | Usernames used to connect within the last 21 days. |
| users-1m | 5400 | Usernames used to connect within the last month. |
| users-3m | 10941 | Usernames used to connect within the last 3 months. |
| passwords-1d | 994 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 3164 | Passwords used to connect within the last 3 days. |
| passwords-1w | 19485 | Passwords used to connect within the last 7 days. |
| passwords-3w | 59113 | Passwords used to connect within the last 21 days. |
| passwords-1m | 65782 | Passwords used to connect within the last month. |
| passwords-3m | 121372 | Passwords used to connect within the last 3 months. |
...
| destinations-1w | 30 | Destinations of proxy attempts within the last 7 days. |
...
| payloads-1w | 79 | Payloads execution attempts within the last 7 days. |
| payloads-3w | 170 | Payloads execution attempts within the last 21 days. |
| payloads-1m | 431 | Payloads execution attempts within the last month. |
| payloads-3m | 888 | Payloads execution attempts within the last 3 months. |
...
| new-passwords-1d | 70 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 212 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 2415 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 6924 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 9699 | New passwords used to connect within the last month. |
| new-passwords-3m | 51061 | New passwords used to connect within the last 3 months. |
