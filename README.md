...
| --- | --- | --- |
| hosts-1d | 1524 | Hosts that connected within the last 24 hours. |
| hosts-3d | 2565 | Hosts that connected within the last 3 days. |
| hosts-1w | 3818 | Hosts that connected within the last 7 days. |
| hosts-3w | 6756 | Hosts that connected within the last 21 days. |
| hosts-1m | 8620 | Hosts that connected within the last month. |
| hosts-3m | 15443 | Hosts that connected within the last 3 months. |
| users-1d | 913 | Usernames used to connect within the last 24 hours. |
| users-3d | 2573 | Usernames used to connect within the last 3 days. |
| users-1w | 3100 | Usernames used to connect within the last 7 days. |
| users-3w | 4372 | Usernames used to connect within the last 21 days. |
| users-1m | 5267 | Usernames used to connect within the last month. |
| users-3m | 10427 | Usernames used to connect within the last 3 months. |
| passwords-1d | 6943 | Passwords used to connect within the last 24 hours. |
| passwords-3d | 23485 | Passwords used to connect within the last 3 days. |
| passwords-1w | 30529 | Passwords used to connect within the last 7 days. |
| passwords-3w | 62493 | Passwords used to connect within the last 21 days. |
| passwords-1m | 67025 | Passwords used to connect within the last month. |
| passwords-3m | 93770 | Passwords used to connect within the last 3 months. |
...
| payloads-1w | 54 | Payloads execution attempts within the last 7 days. |
...
| new-passwords-1d | 2431 | New passwords used to connect within the last 24 hours. |
| new-passwords-3d | 10219 | New passwords used to connect within the last 3 days. |
| new-passwords-1w | 12725 | New passwords used to connect within the last 7 days. |
| new-passwords-3w | 35039 | New passwords used to connect within the last 21 days. |
| new-passwords-1m | 36764 | New passwords used to connect within the last month. |
| new-passwords-3m | 46196 | New passwords used to connect within the last 3 months. |
